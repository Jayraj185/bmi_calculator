...
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    ...
    animation2 = Tween(begin: 1.0,end: 0.0).animate(CurvedAnimation(parent: animationController!, curve: Curves.fastOutSlowIn));
                    ...
                    Transform(
                      ...
                      child: GestureDetector(
                        onTap: (){
                          ...
                          showModalBottomSheet(context: context, builder: (context) => ProviderFalse!.bottomsheet(context),);
                        },
                        child: Container(
                          height: 60,
                          width: 330,
